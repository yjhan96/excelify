...
export function SpreadsheetGrid({
    ...
    const handleCellUpdate = (
        ...
        updateCellValue(dispatchSheets, value, pos);
    };
    ...
    return (
        ...
        >
            ...
            >
                {cellsToRender.map(
                    ({ row, col, value, isEditable, valueColor }) => {
                        const isEditing =
                            editingCell?.row === row &&
                            editingCell?.col === col;
                        const isSelected =
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    width: `${isEditing ? expandedCellDim?.width : colWidths[col]}px`,
                                }}
